...
import jwt
from constant import ALGO, SECRET, PWD_HASH_ITERATIONS, PWD_HASH_SALT
from implemented import user_service


def generate_tokens(username, password, role, is_refresh=False):
    """
        создание доступа и обновление tokens
    """
